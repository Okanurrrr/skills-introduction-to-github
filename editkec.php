...
// Query data kecamatan berdasarkan ID
$datakec = query("SELECT * FROM datakec WHERE id = $id")[0];

// Tombol submit sudah ditekan atau belum
if (isset($_POST["submit"])) {
    // Data berhasil di-edit atau tidak
    if (editkec($_POST) > 0) {
        echo "
        <script>
        alert('Data berhasil diedit!');
        window.location.href = 'datakec.php';
        </script> ";
    } else {
        echo "
        <script>
